...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func application(application: UIApplication, didReceiveRemoteNotification userInfo: [NSObject : AnyObject], fetchCompletionHandler completionHandler: (UIBackgroundFetchResult) -> Void) {
        ...
        print(myCKNotification.notificationType)
    ...
    func saveNewObject() {
        ...
        let record = CKRecord(recordType: "SampleCloudKitPush")
        record.setObject("SampleCloudKitPush", forKey: "SampleCloudKitPush")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "jp.co.JchanKchan.CloudKitSample" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("CloudKitSample", withExtension: "momd")!
